 ...
 * @date   February, 2019
 *
 * This file shows a sample implementation for a class Person that employs C++ class Constructors, Destructors, static Members, and friend(s) for the purposes of CS-202
 */
...
bool Person::parameterValidation() const{  // const member function, calling object's members cannot be modified 
