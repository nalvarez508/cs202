(function(window) {
    ...
    var account = window[window.MailerLiteObject]('accounts')('381541', 'z7o9v6x3r7');
...
(function (window) {
    ...
    cookieName = 'mailerlite:webform:submited:289475';
    var lastSubmited = getCookie(cookieName);

    if (!lastSubmited) {
    
var cookieName = 'mailerlite:webform:shown:289475';
...
if (show) {
  ...
  var urls = [];
      ...
      urls.push('https://www.sanfoundry.com');
        urls.push('https://sanfoundry.com');
...
urls.forEach(function(url) {
      ...
      if (allow) {
          ...
          var webform = account('webforms', 289475, 'v0a8h6', 'load');
